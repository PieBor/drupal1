...
class __TwigTemplate_50987650b9802f5766a237525fac2830 extends Template
{
...
($context["node"] ?? null), "isPromoted", [], "method", false, false, true, 72)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? ("is-promoted") : ("")), (((($tmp = CoreExtension::getAttribute($this->env, $this->source,         // line 73
($context["node"] ?? null), "isSticky", [], "method", false, false, true, 73)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? ("is-sticky") : ("")), (((($tmp =  !CoreExtension::getAttribute($this->env, $this->source,         // line 74
($context["node"] ?? null), "isPublished", [], "method", false, false, true, 74)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? ("is-unpublished") : ("")), (((($tmp =         // line 75
($context["view_mode"] ?? null)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? (\Drupal\Component\Utility\Html::getClass(($context["view_mode"] ?? null))) : ("")), "clearfix"];
        // line 79
        yield "<article";
...
";
    ...
    {
        static $tags = ["set" => 70, "if" => 82, "trans" => 93];
        static $filters = ["escape" => 68, "clean_class" => 71];
