...
/* menu.html.twig */
class __TwigTemplate_221913bec6208de33f41a127da5e5729 extends Template
{
...
$context["item"], "is_expanded", [], "any", false, false, true, 31) && CoreExtension::getAttribute($this->env, $this->source, $context["item"], "below", [], "any", false, false, true, 31))) ? ("expanded dropdown") : ("")), (((($tmp = CoreExtension::getAttribute($this->env, $this->source,                     // line 32
$context["item"], "in_active_trail", [], "any", false, false, true, 32)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? ("active active-trail") : ("")), (((($tmp = CoreExtension::getAttribute($this->env, $this->source,                     // line 33
$context["loop"], "first", [], "any", false, false, true, 33)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? ("first") : ("")), (((($tmp = CoreExtension::getAttribute($this->env, $this->source,                     // line 34
$context["loop"], "last", [], "any", false, false, true, 34)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? ("last") : (""))];
                    // line 37
                    yield "      <li";
