...
class __TwigTemplate_607a18af3e8efafc7a9ab4b551e986ec extends Template
{
    ...
    {
        $macros = $this->macros;
        $this->parent = $this->load("input.html.twig", 1);
...
($context["icon"] ?? null) && ($context["icon_position"] ?? null)) &&  !($context["icon_only"] ?? null))) ? (("icon-" . ($context["icon_position"] ?? null))) : (""))];
  ...
  ";
    ...
    {
        static $tags = ["extends" => 1, "apply" => 25, "set" => 27, "if" => 33];
        static $filters = ["escape" => 34, "spaceless" => 25];
        static $functions = [];
