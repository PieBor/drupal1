...
class __TwigTemplate_cb95167e5ddc5987923def4c01d946e9 extends Template
{
...
($context["is_form_group"] ?? null)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? ("form-group") : ("")), (((($tmp =         // line 61
($context["is_radio"] ?? null)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? ("radio") : ("")), (((($tmp =         // line 62
($context["is_checkbox"] ?? null)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? ("checkbox") : ("")), (((($tmp =         // line 63
($context["is_autocomplete"] ?? null)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? ("form-autocomplete") : ("")), (((($tmp =         // line 64
($context["has_error"] ?? null)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? ("error has-error") : (""))];
        // line 67
